...
Write-Host "`n--- 2. TEST SPOJENÍ MEZI PC A MODEMEM ($gateway) ---" -ForegroundColor Cyan; Write-Host "Pokud uvidis 'Ztraceno / Lost > 0', signal k tobe nedoleti v poradku." -ForegroundColor Yellow; ping -n 20 $gateway
